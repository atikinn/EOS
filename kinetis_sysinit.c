...
void svcHandler() __attribute__ ((weak, alias("Default_Handler")));
...
void (* const InterruptVector[])() __attribute__ ((section(".vectortable"))) = {
  ...
  0,						/* Vector 13 */
  PendSV_Handler,			/* Vector 14: Pendable request for system service (PendSV) */
  ...
  Default_Handler,		/* Vector 36: Mode Controller, Low-voltage Detect, low-voltage Warning */
